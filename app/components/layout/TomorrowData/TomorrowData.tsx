...
const TomorrowData = ({ date, condition, temp_c, temp_f, sunrise, sunset, unit }: TomorrowDataComponentProps) => {
    const temperature = unit === 'C' ? temp_c : temp_f;
    const summary = condition ?? 'Sunny';
    ...
    return (
        <div className='lg:min-w-sm xl:min-w-md w-full py-4 px-5 bg-[#d9d9d9] dark:bg-[#444] text-[#292929] dark:text-white rounded-[30px] shadow-[10px_10px_4px_0px_rgba(0,0,0,0.5)]'>
            ...
            <div className='grid grid-cols-2 items-center text-center'>
                <Image width={200} height={200} alt='tomorrow sky' src={Images.sunny} className='mx-auto mb-3 col-end-3 col-start-1 sm:mb-0 sm:col-end-2 sm:col-start-1' />
